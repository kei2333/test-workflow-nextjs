...
const getNotificationStyles = (type: Type) => {
  const baseClasses = "mb-4 p-4 rounded-lg shadow-lg flex items-center justify-between max-w-sm";
...
export const NotificationComponent: React.FC<NotificationProps> = ({ notification, onRemove }) => {
  return (
    <div 
